...
if (!isset($param['appid']) || $param['appid'] == null) $data = generateJsonString($param['version'], $param['uin']); // 生成JSON字符串
else $data = generateJsonString($param['version'], $param['uin'], $param['appid']);
